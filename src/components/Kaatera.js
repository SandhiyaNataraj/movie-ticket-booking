          ...
          >
            ...
            <div style={{ flex: '1', marginRight: '30px', marginLeft: '200px' }}>
              <Card style={{ width: '50%' }}>
                <Card.Img
                  variant="top"
                  src="https://assets-in.bmscdn.com/iedb/movies/images/mobile/thumbnail/xlarge/kaatera-et00355776-1680501742.jpg"
                  style={{ width: '100%', height: '400px' }}
                />
                <Card.Body>
                  <Card.Title>About the movie</Card.Title>
                  <Card.Text>
                  Kaatera is a Kannada movie starring Darshan Thoogudeepa, Jagapati Babu, and Radhana Ram in prominent roles. It is directed by Tharun Sudhir.
                  </Card.Text>
                </Card.Body>
              </Card>
            </div>
            ...
            <div style={{ flex: '1', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <Link to="/rate">
                <h5 style={{ color: 'black', margin: '0', cursor: 'pointer', marginTop: '20px' }}>49.9K are interested</h5>
                </Link>
              </div>
              <div>
