      ...
      >
        ...
        <div style={{ flex: '1', marginRight: '30px', marginLeft: '200px' }}>
          <Card style={{ width: '50%' }}>
            <Card.Img
              variant="top"
              src="https://assets-in.bmscdn.com/iedb/movies/images/mobile/thumbnail/xlarge/jigiri-dosthu-et00379138-1702297230.jpg"
              style={{ width: '100%', height: '400px' }}
            />
            <Card.Body>
              <Card.Title>About the movie</Card.Title>
              <Card.Text>
              Three best friends - Vicky, Rishi and Loki are enroute to Mahabalipuram, when they witness a girl being kidnapped. How they save the girl using their latest technology, forms the crux of the story.
              </Card.Text>
            </Card.Body>
          </Card>
        </div>
        ...
        <div style={{ flex: '1', display: 'flex', flexDirection: 'column' }}>
          <h2 style={{ color: 'black', marginTop: '50px' }}>Jigiri Dosthu</h2>
          ...
          <h5 style={{ color: 'blue', marginTop: '20px' }}>1h 49m . Comedy,Thriller . U .22 Dec,2023</h5>
