          ...
          >
            ...
            <div style={{ flex: '1', marginRight: '30px', marginLeft: '200px' }}>
              <Card style={{ width: '50%' }}>
                <Card.Img
                  variant="top"
                  src="https://assets-in.bmscdn.com/iedb/movies/images/mobile/thumbnail/xlarge/theedhum-soodhum-endhan-mugavari-et00378120-1701688492.jpg"
                  style={{ width: '100%', height: '400px' }}
                />
                <Card.Body>
                  <Card.Title>About the movie</Card.Title>
                  <Card.Text>
                  Shiva and Jessy are in love but Jessy's father strongly opposes the union. Shiva joins hands with a criminal with his own agenda. Will it end well for Shiva and Jessy?
                  </Card.Text>
                </Card.Body>
              </Card>
            </div>
            ...
            <div style={{ flex: '1', display: 'flex', flexDirection: 'column' }}>
              <h2 style={{ color: 'black', marginTop: '50px' }}>Theedhum Soodhum Endhan Mugavari</h2>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <Link to="/rate">
                <h5 style={{ color: 'black', margin: '0', cursor: 'pointer', marginTop: '20px' }}>8.1/10 294 ---></h5>
                </Link>
              </div>
              <div>
              ...
              <h5 style={{ color: 'blue', marginTop: '20px' }}>1h 58m . Crime,Thriller . UA .15 Dec,2023</h5>
