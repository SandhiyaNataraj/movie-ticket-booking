      ...
      >
        ...
        <div style={{ flex: '1', marginRight: '30px', marginLeft: '200px' }}>
          <Card style={{ width: '50%' }}>
            ...
            <Card.Img
              variant="top"
              src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:l-image,i-discovery-catalog@@icons@@star-icon-202203010609.png,lx-24,ly-615,w-29,l-end:l-text,ie-OC4xLzEwICAxLjVLIFZvdGVz,fs-29,co-FFFFFF,ly-612,lx-70,pa-8_0_0_0,l-end/et00379108-ubqwlmsaaj-portrait.jpg"
        ...
        <div style={{ flex: '1', display: 'flex', flexDirection: 'column' }}>
          <h2 style={{ color: 'black', marginTop: '50px' }}>Kannagi</h2>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Link to="/rate">
            <h5 style={{ color: 'black', margin: '0', cursor: 'pointer', marginTop: '20px' }}>8.1/10 1.5K Votes---></h5>
            </Link>
          </div>
          <div>
          ...
          <h5 style={{ color: 'blue', marginTop: '20px' }}>2h 38m . Drama . UA .15 Dec,2023</h5>
