          ...
          >
            ...
            <div style={{ flex: '1', marginRight: '30px', marginLeft: '200px' }}>
              <Card style={{ width: '50%' }}>
                <Card.Img
                  variant="top"
                  src="https://assets-in.bmscdn.com/iedb/movies/images/mobile/thumbnail/xlarge/3-et00008364-1662450612.jpg"
                  style={{ width: '100%', height: '400px' }}
                />
                <Card.Body>
                  <Card.Title>About the movie</Card.Title>
                  <Card.Text>
                  High school sweethearts Ram and Janani eventually get married. However, when Ram suddenly commits suicide, a heartbroken and confused Janani tries to find out the reason.
                  </Card.Text>
                </Card.Body>
              </Card>
            </div>
            ...
            <div style={{ flex: '1', display: 'flex', flexDirection: 'column' }}>
              <h2 style={{ color: 'black', marginTop: '50px' }}>3</h2>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <Link to="/rate">
                <h5 style={{ color: 'black', margin: '0', cursor: 'pointer', marginTop: '20px' }}>9.1/10 14.8K votes ---></h5>
                </Link>
              </div>
              <div>
