      ...
      >
        ...
        <div style={{ flex: '1', marginRight: '30px', marginLeft: '200px' }}>
          <Card style={{ width: '50%' }}>
            <Card.Img
              variant="top"
              src="https://assets-in.bmscdn.com/iedb/movies/images/mobile/thumbnail/xlarge/shaan-love-war-et00379271-1702378632.jpg"
              style={{ width: '100%', height: '400px' }}
            />
            <Card.Body>
              <Card.Title>About the movie</Card.Title>
              <Card.Text>
              Shivaji, a benevolent Zamindar's son, manages a quarry but eventually gets murdered. Years later, Shaan, his son, uncovers the truth and brings about justice in hopes of solace and happiness for his family.
              </Card.Text>
            </Card.Body>
          </Card>
        </div>
        ...
        <div style={{ flex: '1', display: 'flex', flexDirection: 'column' }}>
          <h2 style={{ color: 'black', marginTop: '50px' }}>Shaan</h2>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <img style={{ width: '23px', marginRight: '5px', marginTop: '20px' }}
             ...
             <Link to="/rate">
            <h5 style={{ color: 'black', margin: '0', cursor: 'pointer', marginTop: '20px' }}>136 are interested</h5>
            </Link>
          </div>
          <div>
          ...
          <h5 style={{ color: 'blue', marginTop: '20px' }}>2h . Drama,Family .  UA </h5>
